...
class Game_auditivo_5 extends StatefulWidget {
  static String tag = 'Game-auditivo-5';
  @override
  State<Game_auditivo_5> createState() => _MyStatefulWidgetState();
}

class _MyStatefulWidgetState extends State<Game_auditivo_5>
  ...
  void initState() {
    ...
    audioPlayer.open(Audio('assets/sound/Bye!.mp3'),autoStart: true,showNotification: true);
  }
                              ...
                              child: Column (
                                children: [
                                  ...
                                  Center(
                                      ...
                                      Column(
                                        children: [
                                          Text("Qual imagem melhor descreve o audio abaixo?",
                                            style: TextStyle(
                                              decoration: TextDecoration.none,
                                              color: Colors.orange[800],
                                              fontSize: 20,
