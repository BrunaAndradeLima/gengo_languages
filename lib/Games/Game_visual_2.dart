...
class Game_visual_2 extends StatefulWidget {
  static String tag = 'Game-visual-2';
  @override
  State<Game_visual_2> createState() => _MyStatefulWidgetState();
}

class _MyStatefulWidgetState extends State<Game_visual_2> {
            ...
            Card(
              child: SimpleDialogOption(
                ...
                onPressed: (){
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => Game_visual_3()),
                  );
                              ...
                              child: Column (
                                children: [
                                  ...
                                  Center(
                                      ...
                                      Column(
                                        children: [
                                          Text("Qual dessas palavras corresponde a palavra 'Olá' em inglês?",
                                            style: TextStyle(
                                              decoration: TextDecoration.none,
                                              color: Colors.orange[800],
                                              fontSize: 20,
