...
class Game_auditivo_2 extends StatefulWidget {
  static String tag = 'Game-auditivo-2';
  @override
  State<Game_auditivo_2> createState() => _MyStatefulWidgetState();
}

class _MyStatefulWidgetState extends State<Game_auditivo_2>
            ...
            Card(
              child: SimpleDialogOption(
                ...
                onPressed: (){
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => Game_auditivo_3()),
                  );
